        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?php echo ($page == 'general-settings' || $page == 'push-notifications-system' || $page == 'site-settings' || $page == 'payment-settings' || $page == 'email-settings' || $page == 'social-login' || $page == 's3' || $page == 'import-settings') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'import-settings') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo LoadAdminLinkSettings('import-settings'); ?>">Import Settings</a>
                            </li>

                        </ul>
                    </li>

                    <li <?php echo ($page == 'manage-albums' || $page == 'manage-track-reviews' || $page == 'manage-playlist' || $page == 'manage-categories' || $page == 'add-categories' || $page == 'edit-categories' || $page == 'manage-songs' || $page == 'add-songs' || $page == 'edit-songs' || $page == 'manage-song-price' || $page == 'add-song-price' || $page == 'edit-song-price' || $page == 'payment-requests') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'manage-track-reviews') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo LoadAdminLinkSettings('manage-track-reviews'); ?>">Manage Song Reviews</a>
                            </li>
                        </ul>
                    </li>

                    <li <?php echo ($page == 'manage-users'  || $page == 'manage-artists' || $page == 'manage-profile-fields' || $page == 'add-new-profile-field' || $page == 'edit-profile-field' || $page == 'verification-requests' || $page == 'affiliates-settings') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'manage-profile-fields' || $page == 'add-new-profile-field' || $page == 'edit-profile-field' ) ? 'class="active"' : ''; ?>>
                                <a href="<?php echo LoadAdminLinkSettings('manage-profile-fields'); ?>">Manage Custom Profile Fields</a>
                            </li>
                            <li <?php echo ($page == 'affiliates-settings') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo LoadAdminLinkSettings('affiliates-settings'); ?>">Affiliates Settings</a>
                            </li>
                        </ul>
...
<!--                            </li>-->
                    ...
                    <li <?php echo ($page == 'manage-articles' || $page == 'add-new-article' || $page == 'manage-blog-categories' || $page == 'edit-article') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'manage-articles' || $page == 'edit-article') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo LoadAdminLinkSettings('manage-articles'); ?>">Manage Blog</a>
                            </li>
                            <li <?php echo ($page == 'manage-blog-categories') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo LoadAdminLinkSettings('manage-blog-categories'); ?>">Blog categories</a>
                            </li>
                            <li <?php echo ($page == 'add-new-article') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo LoadAdminLinkSettings('add-new-article'); ?>">Add New article</a>
                            </li>
                        </ul>
                    </li>
                    <li <?php echo ( $page == 'manage-website-ads' || $page == 'manage-user-ads' ) ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'manage-user-ads') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo LoadAdminLinkSettings('manage-user-ads'); ?>">Manage Users Ads</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'manage-announcements' || $page == 'mass-notifications' || $page == 'manage-invitation-keys' || $page == 'ban-users' || $page == 'fake-users' || $page == 'create-new-sitemap' || $page == 'backup' || $page == 'auto-friend' ) ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'create-new-sitemap') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo LoadAdminLinkSettings('create-new-sitemap'); ?>">Generate SiteMap</a>
                            </li>
                     ...
                     <li <?php echo ($page == 'manage-pages' || $page == 'manage-custom-pages' || $page == 'add-new-custom-page' || $page == 'edit-custom-page') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">description</i>
                            <span>Pages</span>
                        </a>
